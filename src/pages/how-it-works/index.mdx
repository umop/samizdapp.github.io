...
<p className="disclaimer">
  <svg
    ...
    xmlSpace="preserve"
  >
    <path d="M26 0C11.664 0 0 11.663 0 26s11.664 26 26 26 26-11.663 26-26S40.336 0 26 0zm2 41a2 2 0 01-4 0v-2a2 2 0 014 0v2zm0-8a2 2 0 01-4 0V11a2 2 0 014 0v22z"></path>
  </svg>
  A core design principle of the samizdapp network is that box owners are the only
  ones that have control over their own data. However, at this stage, our focus is
  on establishing robust connectivity across diverse environments, and offer no guarantees
  as to privacy or anonymity
</p>
