  ...
  return (
    ...
    >
      ...
      <li>
        ...
        has not completed. Setup should not take more than a few minutes. The
        most common cause of setup not completing is bad WiFi credentials.
      </li>
      <br />
      <li>
...
3. Follow the instructions on the right of the "Add new device" screen:
   ...
   <AddNewDevice
     Success={() => (
       <>
         Proceed to <a href="setup-client">setup your client</a>.
       </>
     )}
   />
